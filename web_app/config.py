...
def get_ui_labels(cfg):
    ...
    labels = {
        "fr": {
            ...
            "fp_first_date":            "Première date du jeu de données",
            "fp_last_date":             "Dernière date du jeu de données",
            "crs_remap_title":          "Reprojection",
            ...
            "dt_section_title":   "Données temporelles",
            ...
            "dt_agg_min":            "Minimum",
            "dt_agg_max":            "Maximum",
            "dt_y_label_occupancy":  "Enregristrements actifs",
        ...
        "en": {
            ...
            "fp_first_date":            "First date in dataset",
            "fp_last_date":             "Last date in dataset",
            "crs_remap_title":          "Reprojection",
            ...
            # EN
            "dt_section_title":   "Temporal Data",
            ...
            "dt_agg_min":            "Min",
            "dt_agg_max":            "Max",
            "dt_y_label_occupancy":  "Active records",
